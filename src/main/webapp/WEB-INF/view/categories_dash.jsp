                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="/SplNdProd" class="dropdown-item">Suppliers & Products</a>
                            <a href="/classifiedcategories" class="dropdown-item">Classified Category</a>
                            <a href="/Tradecategories" class="dropdown-item">Show trade lead Category</a>
                        </div>
                    </div>
                    <a href="/ChangeAdminPassword" class="nav-item nav-link"><i class="fa fa-th me-2"></i>Genenral Settings</a>
...
<!--                             <a href="#" class="dropdown-item text-center">See all notifications</a> -->
            ...
            <!-- Sale & Revenue Start -->
<%--            <jsp:include page=''> --%>
                 <jsp:include page="${pageContext.request.contextPath}/WEB-INF/view/categories1.jsp"/>
<%--             <%@include file='${pageContext.request.contextPath}/WEB-INF/view/categories1.jsp' %> --%>
            <!-- Sale & Revenue End -->
            <!-- Footer Start -->
            <div>
