					...
					<div class="sct_right">
						<div id="product_list">
										...
										<div class="table_wrapper">
											<div class="table_wrapper_inner">
												<form name="add_trade_lead" method="post" action>
													<div id="search_val"
														style="display: inline; margin-left: 4px;"></div>
													<div class>
														<div class="form-group">
															<input type="text" placeholder="Category Name "
																class="form-control" name="cat_name" value required />
														</div>
													</div>
													<input type="hidden" name="cat_id" value="0" /> <input
														type="hidden" name="edit_id" value />
													<div class="row">
														<div class="col-md-4">
															<div class="form-group">
																<input type="text" placeholder="Title"
																	class="form-control" name="title" value required />
															</div>
														</div>
														<div class="col-md-4">
															<div class="form-group">
														...
														<div class="col-md-4">
															<div class="form-group">
																<input type="text" placeholder="Description"
																	class="form-control" name="description" value required />
															</div>
														</div>
													</div>
													<div class="row">
														<div class="col-md-12">
															<input type="submit" class="btn btn-primary"
																...
																onclick="return Valid_add_trade_lead(document.add_trade_lead);" />
														</div>
													</div>
												</form>
											</div>
							...
							<div class="table_wrapper">
								<div class="table_wrapper_inner">
									<table
										class="listing table-responsive table-bordered table-striped"
										...
										<td colspan="8"
											style="color: #F00; font-size: 24px; text-align: center">Record
											Not Found</td>
									</table>
								</div>
							</div>
