            ...
            <div class="header_top d_none1">
               <div class="container">
                  <div class="row">
                     <div class="col-md-4">
                        <ul class="conta_icon ">
                           <li id="imgsize"><a><img src="${pageContext.request.contextPath}/img/qralink-img.png" alt="#"/>Call Us: +91-9158119158</a></li>
                        </ul>
                     </div>
                     <div class="col-md-4">
                     ...
                     <div class="col-md-4">
                        <div class="se_fonr1">
                           <form action="#" >
                              <div class="select-box" style="padding-right: 10px;">
                                 <label for="select-box1" class="label select-box1"><span class="label-desc">BUYERS</span> </label>
...
<!--                                     <option value="Choice 3">Neverl</option> -->
                           ...
                           <form action="#" >
                              <div class="select-box" style="padding-right: 10px;">
                                 <label for="select-box1" class="label select-box1"><span class="label-desc">SUPPLIERS</span> </label>
                                 <select id="select-box1" class="select">
                           ...
                           </div><div class="se_fonr1">
                           <form action="#" >
                              <div class="select-box" style="padding-right: 10px;">
                                 <label for="select-box1" class="label select-box1"><span class="label-desc">HELP</span> </label>
                                 <select id="select-box1" class="select">
