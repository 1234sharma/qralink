<%@page import="com.qraAdmin.model.MicroCategoryBean"%>
...
<title>Micro Category Product List</title>
...
MicroCategoryBean microcategory=(MicroCategoryBean)request.getAttribute("microcategory");
...
<%-- 						 <a href="/"> <span><%=microcat.getMICRO_CATEGORY_NAME() %></span></a> --%>
<!-- 					</div> -->
<!-- 				</div> -->
<%-- 			<%}%>			 --%>
<!-- 			</div> -->
...
<!-- 	</div> -->
	<br>
	<br>
		<h1 class="six_box11" style="background-color:#000000; color: white; text-align: center;">Products Available for Micro category <span class="text-danger"><%=microcategory.getMICRO_CATEGORY_NAME()%></span></h1>
	<div class="six_box">
		<div class="container-fluid" >
			<div class="row" id="row_id">
