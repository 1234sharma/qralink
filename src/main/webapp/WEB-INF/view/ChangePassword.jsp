...
<td class="last"><input type="text" class="text form-control" id="admin1" value="admin" name="username" />
<span class="star"></span></td>
<td width="205"><div class="star" id="alert_username"></div></td>
</tr>
<tr class="bg">
<td class="first"><strong>Current password</strong></td>
<td class="last"><input type="password" class="text form-control" id="cur_password" name="cur_password" />
<span class="star"></span></td>
<td><div class="star" id="alert_cur_password"></div></td>
</tr>
<tr class="bg">
<td class="first"><strong>Password</strong></td>
<td class="last"><input type="password" id="password" class="text form-control" name="password" />
<span class="star"></span></td>
<td><div class="star" id="alert_password"></div></td>
</tr>
<tr>
<td class="first"><strong>Retype Password</strong></td>
<td class="last"><input type="password" id="ret_password" class="text form-control" name="ret_password" /></td>
